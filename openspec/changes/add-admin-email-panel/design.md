...
- Use Supabase Auth magic links for admin identity.
...
- Use magic-link authentication instead of passwords. This keeps the first admin flow simple and avoids password reset and credential management UI.
...
- Magic-link emails require Supabase Auth site URL and email templates to be configured correctly -> document the callback route and required environment variables.
